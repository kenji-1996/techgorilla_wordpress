      ...
      <div class="container-fluid p-0">
        <div class="row no-gutters popup-gallery">
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="<?php echo get_bloginfo('template_directory'); ?>/img/portfolio/fullsize/1.jpg">
              <img class="img-fluid" src="<?php echo get_bloginfo('template_directory'); ?>/img/portfolio/thumbnails/1.jpg" alt="">
