...
function techgorilla_scripts() {
    ...
    if(!is_admin()) {//Replace jquery with googles CDN
        ...
        wp_register_script('tether', '//cdnjs.cloudflare.com/ajax/libs/tether/1.4.0/js/tether.min.js',null,null,true);
    }
    wp_enqueue_script('tether');

    if(!is_admin()) {//Replace jquery with googles CDN
        wp_deregister_script( 'bootstrap' );
        wp_register_script('bootstrap', '//stackpath.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js',null,null,true);
    }
    ...
    wp_enqueue_script( 'jquery-magnific-popup', get_template_directory_uri() . '/vendor/magnific-popup/jquery.magnific-popup.min.js',array( 'jquery' ),null,true );
...
//Include non-critical styles in footer
